...
class IMU:
	...
	def config(self):
		...
		#set gyro lowpass
		gconfig1 = self.readFrom(self.gyroConfig1, 1) & 0b10001110
		gconfig1 |= 0b1
		gconfig1 |= (5 & 0x07) << 4
		self.writeTo(self.gyroConfig1, gconfig1)

		#set gyro full scale
		gfullscale = self.readFrom(self.gyroConfig1, 1) & 0b11111001
		...
		aconfig = self.readFrom(self.accelConfig, 1) & 0b10001110
		aconfig |= 0b1
		aconfig |= (5 & 0x07) << 4
